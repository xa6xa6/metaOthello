...
int main(int argc, char** argv)
{
	...
	tmpChrSeqInfoVec.initiate_fa_fileVec_creatDir(outputDir_fa);
	tmpChrSeqInfoVec.printMergedGenome_fa_info(outputMergedFa2taxoInfoFile);
	tmpChrSeqInfoVec.generateMergedGenome_fa();
	return 0;
}