...
void reorder_removeIsolatedKmerValue(vector<valueT>& tmpKmerValueVec_filtered, 
	vector<valueT>& tmpKmerValueVec_raw, int tmpQuerySeqKmerNum_1)
{
...
int main(int argc, char** argv)
{
	...
	for(tmpTurn = 0; ; tmpTurn++)
	{
		...
		for(int tmpOpenMP = 0; tmpOpenMP < realRecordNum; tmpOpenMP++)
		{
			...
			fusionAssignmentInfo.getFusionAssignment(
				fusionAssignment_geneReissuedId_1, fusionAssignment_geneReissuedId_2,				
